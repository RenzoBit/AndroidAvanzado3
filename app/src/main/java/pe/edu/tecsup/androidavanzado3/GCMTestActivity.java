...
public class GCMTestActivity extends Activity {
    ...
    private class TareaRegistroGCM extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String aplicacion = "androidavanzado3";
                ...
                if (registrado) {
                    ...
                    //Toast.makeText(GCMTestActivity.this, "Registrado", Toast.LENGTH_SHORT).show();
                }
    ...
    private boolean registroServidor(String usuario, String regId, String aplicacion, String mac) {
        ...
        try {
            ...
            HttpRequest httpRequest = HttpRequest.post("http://renzovilela.tk/rest/index.php/dispositivos");
